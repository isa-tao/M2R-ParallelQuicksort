...
#+end_src
I obtained the following [[file:data/debian_2014-11-02/measurements_16:17.txt][output]].
...
#+begin_src sh :results output raw :exports both 
  FILENAME="data/debian_2014-11-02/measurements_16:17"
  perl scripts/csv_quicksort_extractor2.pl < "$FILENAME.txt" > "${FILENAME}_wide.csv"
  echo "
    set terminal png size 600,400 
    set output '${FILENAME}_wide.png'
...
#+RESULTS:
[[file:data/debian_2014-11-02/measurements_16:17_wide.png]]
...
#+end_src
I obtained the following [[file:data/sagittaire-78.lyon.grid5000.fr_2014-11-02/measurements_17:47.txt][output]], and used the same script to parse
this result:
#+begin_src sh :results output raw :exports both 
  FILENAME="data/sagittaire-78.lyon.grid5000.fr_2014-11-02/measurements_17:47"
  perl scripts/csv_quicksort_extractor2.pl < "$FILENAME.txt" > "${FILENAME}_wide.csv"
  echo "
    set terminal png size 600,400 
    set output '${FILENAME}_wide.png'
...
#+RESULTS:
[[file:data/sagittaire-78.lyon.grid5000.fr_2014-11-02/measurements_17:47_wide.png]]
...
Here is the [[file:data/debian_2014-11-02/measurements_20:21.txt][output]]. Let's parse this result:
#+begin_src sh :results output raw :exports both 
